{if $prestaShopVersion == "1.5"}
	...
	{foreach $list AS $index => $tr}
		...
		{if $flespakket == 'true'}
			{assign var = flespakketOrderData value = Flespakket::getOrderData($tr.$identifier)}
	
			<td class="center">
				<select name="flespakket_package" id="flespakket_package_{$tr.$identifier}">
			...
			<td class="flespakket_align_right">
				<table class="flespakket_table">
					<tr>
						<td id="flpa_exist_{$tr.$identifier}">
							<div>
	       						<input type="checkbox" value="{$flespakketOrderData.checks}" id="flpa_check_{$tr.$identifier}" class="flpaleft flpacheck">
	       						{$flespakketOrderData.items}
	       					</div>
						</td>
						<td class="flpafunc">
							<a href="#" class="flespakket-consignment-new" onclick="return createNewConsignment('{$tr.$identifier}');"><img src="/modules/flespakket/images/flespakket_pdf_add.png" alt="New"></a>
							<a href="#" class="flespakket-consignment-retour" onclick="return createNewConsignment('{$tr.$identifier}', true);"><img src="/modules/flespakket/images/flespakket_retour_add.png" alt="Retour"></a>
						</td>
					</tr>
				</table>
			</td>
