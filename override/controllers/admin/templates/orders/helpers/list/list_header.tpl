					...
					style="width: 100%; margin-bottom:10px;">
						...
						<thead>
							<tr class="nodrag nodrop" style="height: 40px">
								...
								{if $flespakket == 'true'}
									<th>
	                    				<span class="title_box">Verpakking</span>
	                    				<br/>&nbsp;
									</th>
									<th class="flespakket_align_right">
					                    <a href="#" onclick="return printConsignmentSelection();" class="flespakket-pdf flpaleft">
					                    	<img border="0" alt="Print" src="/modules/flespakket/images/flespakket_pdf.png">
					                   	</a>
	                				    <a href="#" onclick="return processConsignmentSelection();" class="flespakket-pdf flpaleft">
	                				    	<img border="0" alt="Process" src="/modules/flespakket/images/flespakket_pdf_add.png">
	                				    </a>
	
	                    				<span class="title_box">Flespakket</span>
	                    				<br/>&nbsp;
									</th>
								{/if}
...
{elseif $prestaShopVersion == "1.6"}
    <script type="text/javascript">
        // since prestashop 1.6 has checkboxes, we link them to the (hidden) myparcel checkboxes
        $(function(){
            $('input[type="checkbox"][name="orderBox[]"]').on('change', function(){
                $(this).parent().parent().children('.flespakket_align_right').first().find('input[type="checkbox"]').click();
            });
            $('.bulk-actions a').on('click', function(){
                setTimeout(function(){
                    $('.flespakket_table input[type="checkbox"]').attr('checked', false);
                    $('input[type="checkbox"][name="orderBox[]"]').each(function(){
                        var checked = $(this).is(':checked');
                        $(this).parent().parent().children('.flespakket_align_right').first().find('input[type="checkbox"]').attr('checked', checked);
                    });
                }, 337);
            });
            $('.flespakket_table input[type="checkbox"]').hide();
        });
    </script>
	{if $ajax}
	<script type="text/javascript">
			...
			<table
				...
				<thead>
					<tr class="nodrag nodrop">
						...
						{if $flespakket == 'true'}
							<th class="flespakket-select-column">
                				<span class="title_box">Verpakking</span>
							</th>
							<th class="flespakket_align_right flespakket-action-column">
			                    <a href="#" onclick="return printConsignmentSelection();" class="flespakket-pdf flpaleft">
			                    	<img border="0" alt="Print" src="/modules/flespakket/images/flespakket_pdf.png">
			                   	</a>
            				    <a href="#" onclick="return processConsignmentSelection();" class="flespakket-pdf flpaleft">
